    ...
    if(alerta){
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                ...
                <a href="crear_proveedor.php" class="btn btn-success me-2">
                    Nuevo Proveedor
                </a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="editar_proveedor.php?id=<?php echo $fila['id_proveedor']; ?>" 
                        ...
                        <a href="eliminar_proveedor.php?id=<?php echo $fila['id_proveedor']; ?>"
